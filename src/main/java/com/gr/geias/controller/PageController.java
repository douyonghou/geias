...
public class PageController {
     ...
     * @return
     */
    @RequestMapping("/memberdaorulist")
    public String memberdaoruList() {
        return "/html/member-daoru-list.html";
    }
     ...
     * @return
     */
    @RequestMapping("/inexcal")
    public String inExcal(){return "/html/inExcal.html";}
